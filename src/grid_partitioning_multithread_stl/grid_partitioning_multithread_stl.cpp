...
{
	auto app = reinterpret_cast<CircleCollisionGridPartitioningMultiThreaded*>(glfwGetWindowUserPointer(window));
	app->window_resize();
}
...
void CircleCollisionGridPartitioningMultiThreaded::initialize()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::run()
{
	if (!setup_window())
		return false;
...
bool CircleCollisionGridPartitioningMultiThreaded::setup_window()
{
	glfwInit();
...
bool CircleCollisionGridPartitioningMultiThreaded::setup_vulkan()
{
	if (!create_instance())
		return false;
...
bool CircleCollisionGridPartitioningMultiThreaded::create_instance()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::set_up_debug_messenger()
{
#if defined(_DEBUG)
	if (!validation_layers_enabled)
		return false;
...
bool CircleCollisionGridPartitioningMultiThreaded::pick_physical_device()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::check_device_extensions_support()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::create_logical_device()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::create_surface()
{
	return glfwCreateWindowSurface(this->instance, this->window, nullptr, &this->surface) == VK_SUCCESS;
}

bool CircleCollisionGridPartitioningMultiThreaded::create_swap_chain()
{
	// Get Properties
...
bool CircleCollisionGridPartitioningMultiThreaded::create_image_views()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::create_renderpass()
{
	// Graphics Subpass
...
bool CircleCollisionGridPartitioningMultiThreaded::create_descriptor_set_layout()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::create_graphics_pipeline()
{
	std::string path = files::get_app_path();

	auto vert_shader = read_file(path + "\\..\\..\\..\\..\\..\\src\\grid_partitioning_multithread_stl\\shaders\\shaders.vert.spv");
	auto frag_shader = read_file(path + "\\..\\..\\..\\..\\..\\src\\grid_partitioning_multithread_stl\\shaders\\shaders.frag.spv");
...
bool CircleCollisionGridPartitioningMultiThreaded::create_vertex_buffer()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::create_index_buffer()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::create_instance_buffers()
{
	setup_circles();
...
bool CircleCollisionGridPartitioningMultiThreaded::create_uniform_buffers()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::create_descriptor_pool()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::create_descriptor_sets()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::create_frame_buffers()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::create_command_pool()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::create_command_buffers()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::create_sync_objects()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::cleanup_swap_chain()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::recreate_swap_chain()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::set_viewport_scissor()
{
	this->viewport = {};
	viewport.x = 0.0f;
	viewport.y = 0.0f;
...
void CircleCollisionGridPartitioningMultiThreaded::update(const uint32_t& current_image)
{
...
bool CircleCollisionGridPartitioningMultiThreaded::draw_frame()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::main_loop()
{
...
void CircleCollisionGridPartitioningMultiThreaded::create_threads()
{
	...
	const size division = this->grid.partition_indexes.size() / num_threads;

	for (size_t id = 0; id < num_threads; ++id)
	{
		const size_t minp = id * division;
		const size_t maxp = (id == num_threads - 1) ? this->grid.partition_indexes.size() : (id + 1) * division;

		thread_pool.add_job(id, [&, id](const size_t minp, const size_t maxp)
			{
					...
					for (uint16_t k = minp; k < maxp; ++k)
					{
						...
						for (size_t n = 0; n < partition_size; ++n)
						{
							for (size_t m = n + 1; m < partition_size; ++m)
							{
								...
								if (dis2 < radii * radii)
								{
									collided_local.push_back(std::pair<size_t, size_t>(i, j));
								}
							}
						}
					}
...
bool CircleCollisionGridPartitioningMultiThreaded::release()
{
	if (is_released)
		return true;
...
void CircleCollisionGridPartitioningMultiThreaded::window_resize()
{
	this->should_recreate_swapchain = true;
}

bool CircleCollisionGridPartitioningMultiThreaded::create_colors_buffer()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::create_positions_buffer()
{
...
bool CircleCollisionGridPartitioningMultiThreaded::create_scales_buffer()
{
...
void CircleCollisionGridPartitioningMultiThreaded::setup_circles()
{
