...
bool CircleCollisionComputeShader::prepare_compute()
{
    ...
    auto pos_buffer_desc = this->compute.position_buffer.get_descriptor_info();
    auto scales_buffer_desc = this->compute.scales_buffer.get_descriptor_info();
    auto velocity_buffer_desc = this->compute.velocities_buffer.get_descriptor_info();
    auto ubo_buffer_desc = this->compute.ubo_buffer.get_descriptor_info();
