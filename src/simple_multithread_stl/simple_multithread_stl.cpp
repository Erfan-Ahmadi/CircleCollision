...
{
	auto app = reinterpret_cast<CircleCollisionMultiThreaded*>(glfwGetWindowUserPointer(window));
	app->window_resize();
}
...
bool CircleCollisionMultiThreaded::run()
{
	if (!setup_window())
		return false;
...
bool CircleCollisionMultiThreaded::setup_window()
{
	glfwInit();
...
bool CircleCollisionMultiThreaded::setup_vulkan()
{
	if (!create_instance())
		return false;
...
bool CircleCollisionMultiThreaded::create_instance()
{
...
bool CircleCollisionMultiThreaded::set_up_debug_messenger()
{
#if defined(_DEBUG)
	if (!validation_layers_enabled)
		return false;
...
bool CircleCollisionMultiThreaded::pick_physical_device()
{
...
bool CircleCollisionMultiThreaded::check_device_extensions_support()
{
...
bool CircleCollisionMultiThreaded::create_logical_device()
{
...
bool CircleCollisionMultiThreaded::create_surface()
{
	return glfwCreateWindowSurface(this->instance, this->window, nullptr, &this->surface) == VK_SUCCESS;
}

bool CircleCollisionMultiThreaded::create_swap_chain()
{
	// Get Properties
...
bool CircleCollisionMultiThreaded::create_image_views()
{
...
bool CircleCollisionMultiThreaded::create_renderpass()
{
	// Graphics Subpass
...
bool CircleCollisionMultiThreaded::create_descriptor_set_layout()
{
...
bool CircleCollisionMultiThreaded::create_graphics_pipeline()
{
...
bool CircleCollisionMultiThreaded::create_vertex_buffer()
{
...
bool CircleCollisionMultiThreaded::create_index_buffer()
{
...
bool CircleCollisionMultiThreaded::create_instance_buffers()
{
	setup_circles();
...
bool CircleCollisionMultiThreaded::create_uniform_buffers()
{
...
bool CircleCollisionMultiThreaded::create_descriptor_pool()
{
...
bool CircleCollisionMultiThreaded::create_descriptor_sets()
{
...
bool CircleCollisionMultiThreaded::create_frame_buffers()
{
...
bool CircleCollisionMultiThreaded::create_command_pool()
{
...
bool CircleCollisionMultiThreaded::create_command_buffers()
{
...
bool CircleCollisionMultiThreaded::create_sync_objects()
{
...
bool CircleCollisionMultiThreaded::cleanup_swap_chain()
{
...
bool CircleCollisionMultiThreaded::recreate_swap_chain()
{
...
bool CircleCollisionMultiThreaded::set_viewport_scissor()
{
	this->viewport = {};
	viewport.x = 0.0f;
	viewport.y = 0.0f;
...
bool CircleCollisionMultiThreaded::draw_frame()
{
...
bool CircleCollisionMultiThreaded::main_loop()
{
...
void CircleCollisionMultiThreaded::window_resize()
{
	this->should_recreate_swapchain = true;
}

bool CircleCollisionMultiThreaded::create_colors_buffer()
{
...
bool CircleCollisionMultiThreaded::create_positions_buffer()
{
...
bool CircleCollisionMultiThreaded::create_scales_buffer()
{
...
void CircleCollisionMultiThreaded::setup_circles()
{
